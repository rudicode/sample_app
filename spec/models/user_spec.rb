...
describe User do
	...
	it "should require a name" do
		...
		no_name_user.should_not be_valid
		 # above equivalent to:    no_name_user.valid?.should_not == true
	end
	...
	it "should reject invalid email addresses" do
		addresses = %w[user@foo,com user_at_foo.org example.user@foo. good@address,com]
		addresses.each do |address|
			valid_email_user = User.new(@attr.merge(:email=>address))
	...
	it "should reject duplicate emailaddresses" do
		#Put a user with given email address into data base
    User.create!(@attr)
