  ...
  render_views
	...
	describe "GET 'index'"do
		...
		describe "for signed in users" do
			before(:each) do
				...
				# 30 test users for testing will_pagenate
				30.times do
	...
	describe "GET 'show'" do
		...
		it "should show the users microposts" do
			...
			mp2 = Factory(:micropost, :user => @user, :content => "I hate Foo Bar")
			get :show, :id => @user
	...
	describe "DELETE 'destroy'" do
		...
		describe "as a admin user" do
			...
			before(:each) do
				...
				# with Factories you can do :admin => true/false even though it does not
				# have an attr_accessible defined
